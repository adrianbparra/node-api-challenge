...
- [ ] Mention two parts of Express that you learned about this week.
    ...
    Allows to build RESTful web servides that work with JSON.
    Allows routing for several endpoints.


- [ ] Describe Middleware?

    Can get the request and response objects and operate on them, for example trigger some action.

- [ ] Describe a Resource?

    Is everything that is accessible via a unique URI
